...
def test_get_unique_values_by_header_endpoint():
    ...
    # Probar endpoint get_unique_values con una columna que existe en el test file
    response = client.post(f"/get_unique_values/{file_id}", json={"header": "Departamento"})
